...
@Component({
  selector: "app-dump-upload",
  templateUrl: "dump-upload.component.html",
})
export class DumpuploadComponent implements OnInit {
  ...
  getHeaderArray(csvRecordsArr: any) {
    var headers;
    headers = ['loan_account_number', 'secured_unsecured', 'zone_name', 'branch_name', 'app_branch_code', 'applicant_name', 'scheme_name', 'disb_date'];
  ...
  getDisplayNames(csvRecordsArr: any) {
    ...
    this._ColNameList[0] = "loan_account_number";
    this._ColNameList[1] = "secured_unsecured";
    this._ColNameList[2] = "zone_name";
    this._ColNameList[3] = "branch_name";
    this._ColNameList[4] = "app_branch_code";
    this._ColNameList[5] = "applicant_name";
    this._ColNameList[6] = "scheme_name";
    this._ColNameList[7] = "disb_date";
  ...
  downloadFile() {
    ...
    let csvData = "loan_account_number,secured_unsecured,zone_name,branch_name,app_branch_code,applicant_name,scheme_name,disb_date";
  ...
  prepareTableDataForCSV(tableData) {
    ...
    let tableHeader: any = [
      ...
      { field: 'loan_account_number', header: 'LOAN ACCOUNT NUMBER', index: 2 },
      { field: 'secured_unsecured', header: "SECURED/UNSECURED", index: 1 },
      { field: 'zone_name', header: 'ZONE NAME', index: 2 },
      { field: 'branch_name', header: 'BRANCH NAME', index: 2 },
      { field: 'app_branch_code', header: "APP BRANCH CODE", index: 1 },
